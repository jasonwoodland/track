...
const (
	...
	RunningProjectTaskElapsedTotal         = "Running: <magenta>%s</> <blue>%s</> (%s, %s total)\033[K\n"
	RunningProjectTaskTotal                = "Running: <magenta>%s</> <blue>%s</> (%s)\033[K\n"
	StartedAtTime                          = "Started at <green>%s</>\n"
	StartedAtTimeElapsed                   = "Started at <green>%s</> (%s ago)\033[K\n"
	StoppedProjectTaskElapsedTotal         = "Stopped: <magenta>%s</> <blue>%s</> (%s, %s total)\033[K\n"
	Task                                   = "  <blue>%s</>\n"
